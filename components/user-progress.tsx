...
function UserProgressComponent({ activeCourse,
    hearts,
    points,
        ...
        <div className='flex items-center justify-between gap-x-2 w-full'>
            <Link href={'/courses'}>
                <Button variant={'ghost'}>
                    <Image src={activeCourse.imgSrc} className='rounded-md border' alt={activeCourse.title}
                        height={32} width={32}
                    />
                </Button>
            </Link>
            <Link href={'/shop'}>
                <Button variant={'ghost'} className='text-orange-600'>
                    <Image src={"/points.svg"} height={28} width={28} alt='points' className='mr-2' />{points}
                </Button>
            </Link>
            <Link href={'/shop'}>
